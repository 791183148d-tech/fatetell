...
from bazi_engine import TIAN_GAN_EN
from models.order import create_order
from services.bazi_service import get_or_calc_bazi, compatibility_score
from api._utils import get_session_id, get_price

bazi_bp = Blueprint("bazi", __name__)


# ── Preview (conversion funnel step 1) ──────────────────────────────
...
def preview():
    ...
    try:
        bazi = get_or_calc_bazi(year, month, day, hour, minute, gender)
